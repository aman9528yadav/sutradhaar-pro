...
export function ProfilePage({ onNavigate }: ProfilePageProps) {
    ...
    const displayName = clerkUser?.fullName || clerkUser?.firstName || profile.name || 'Guest User';
    const email = clerkUser?.primaryEmailAddress?.emailAddress || profile.email || 'No email';
    const photoUrl = clerkUser?.imageUrl || profile.photoUrl;

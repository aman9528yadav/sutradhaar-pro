...
export function Header() {
  ...
  const displayName = clerkUser?.fullName || clerkUser?.firstName || (user ? (user.displayName || profile.name) : 'Guest');
  const avatarUrl = clerkUser?.imageUrl || user?.photoURL || profile.photoUrl;
